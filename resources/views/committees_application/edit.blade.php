                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="applicant_date" id="applicant_date" value="{{ $committees_application->applicant_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="fiscal_year" id="fiscal_year" placeholder="অর্থ বছর" value="{{ $committees_application->fiscal_year }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="office_name" id="office_name" placeholder="অফিসের নাম" value="{{ $committees_application->office_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="employee_name" id="employee_name" placeholder="কর্মকর্তা/ কর্মচারীর নাম" value="{{ $committees_application->employee_name }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="ERP_number" id="ERP_number" placeholder="ই আর পি নম্বর" value="{{ $committees_application->ERP_number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="designation" id="designation" placeholder="পদবী" value="{{ $committees_application->designation }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="joining_date" id="joining_date" value="{{ $committees_application->joining_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="grade" id="grade" placeholder="গ্রেড" value="{{ $committees_application->grade }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="number" class="form-control" name="number" id="number" placeholder="মোবাইল নং" value="{{ $committees_application->number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="email" class="form-control" name="email" id="email" placeholder="ইমেইল" value="{{ $committees_application->email }}">
                                </div>
                            </div>
                        </div>
                    </div>  
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="applicant_reason" id="applicant_reason">
                                       <option value="">{{ $committees_application->applicant_reason }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="relation_name" id="relation_name">
                                       <option value="">{{ $committees_application->relation_name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="help_type" id="help_type">
                                       @if(App\Models\Back\Daughter_Marriage::where('application_id', $committees_application->id)->first())
                                       <option value=" {{ App\Models\Back\Daughter_Marriage::where('application_id', $committees_application->id)->first('help_type')}}"> {{App\Models\Back\Daughter_Marriage::where('application_id', $committees_application->id)->first()->help_type}}</option>

                                       @elseif( App\Models\Back\Meritocracy::where('application_id', $committees_application->id)->first())
                                       <option value=" {{ App\Models\Back\Meritocracy::where('application_id', $committees_application->id)->first('help_type')}}"> {{App\Models\Back\Meritocracy::where('application_id', $committees_application->id)->first()->help_type}}</option>

                                       @elseif( App\Models\Back\Deadbody::where('application_id', $committees_application->id)->first())
                                       <option value=" {{ App\Models\Back\Deadbody::where('application_id', $committees_application->id)->first('help_type')}}"> {{App\Models\Back\Deadbody::where('application_id', $committees_application->id)->first()->help_type}}</option>
                                       @endif
                                    </select>
                                </div>
                            </div>
                                ...
                                <table id="orders" class="table table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: black;">পরীক্ষান্তে বিলের পরিমাণ</th>
                                    </thead>
                                    <tbody style="background-color: f4f4f4;">
                                        ...
                                        <tr id="row">
                                            ...
                                            <!-- <td>
                                                <div class="dropdown">
                                                    <button class="btn btn-sm btn-primary dropdown-toggle{{ $application->status == 2 ? ' btn-danger' : '' }}" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                                        {{ $application->status == 1 ? 'Approved' : 'Rejected' }}
                                                    </button>
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <li><a class="dropdown-item" href="{{ route('status.committeesApplication', [$application->id, 'status' => 1]) }}">Approved</a></li>
                                                        <li><a class="dropdown-item{{ $application->status == 2 ? ' text-danger' : '' }}" href="{{ route('status.committeesApplication', [$application->id, 'status' => 2]) }}">Rejected</a></li>
                                                    </ul>
                                                </div>
                                            </td> -->
                                        ...
                                        <tr id="totalRow">
                                            <td colspan="3" class="text-right">দাবিকৃত বিলের পরিমাণ :</td>
                                            <td>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="employee_sign" id="employee_sign" placeholder="কর্মকর্তা/ কর্মচারীর সাক্ষর" value="{{ $committees_application->employee_sign }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="employee_date" id="employee_date" placeholder="তারিখ" value="{{ $committees_application->employee_date }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="doctor_name" id="doctor_name"  value="{{ $committees_application->doctor_name }}" placeholder="অনুমোদিত চিকিৎসকের নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="doctor_designation" id="doctor_designation"  value="{{ $committees_application->doctor_designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="doctor_date" id="doctor_date" placeholder="তারিখ" value="{{ $committees_application->doctor_date }}" placeholder="তারিখ">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="controller_officer_name" id="controller_officer_name"  value="{{ $committees_application->controller_officer_name }}" placeholder="নিয়ন্ত্রণকারী কর্মকর্তার নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="controller_officer_designation" id="controller_officer_designation"  value="{{ $committees_application->controller_officer_designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="controller_officer_date" id="controller_officer_date" placeholder="তারিখ" value="{{ $committees_application->controller_officer_date }}" >
                                    </div>
                                </div>
                            </div>
