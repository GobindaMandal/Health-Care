        ...
        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12">
            ...
            <div class="form-body">
                <form id="myForm" action="{{ route('store.application', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input type="text" class="form-control" name="applicant_reason" id="applicant_reason" placeholder="আবেদনের খাত" value="চিকিৎসা">
                                    <span class="text-danger">
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12" id="treatment_type_container">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12" id="patient_name_container">
                            <div class="row ">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12" id="patient_nid_container">
                            <div class="row ">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12" id="patient_pic_container">
                            <div class="row ">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <div class="row" id="treatment_table">
