            ...
            <div class="container mx-auto px-6 py-1 pb-16">
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.users.store')}}">
                  ...
                  <div class="flex flex-col space-y-2 pb-3">
                    <label for="designation" class="text-gray-700 select-none font-medium">Office</label>
                    <select class="form-control select2" name="office_name" id="office_name">
                      <option value=""></option>
                      @foreach($offices as $office)
                      <option value="{{ $office->office_name }}">{{ $office->office_name }}~{{ $office->office_code }}</option>
                      @endforeach
                    </select>
                  </div>
                  ...
                  <div class="flex flex-col space-y-2 pb-3">
                    ...
                    <input id="number" type="number" name="number" value="{{ old('number') }}"
