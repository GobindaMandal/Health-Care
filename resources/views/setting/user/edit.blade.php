              ...
              <div class="bg-white shadow-md rounded my-6 p-5">
                <form method="POST" action="{{ route('admin.users.update',$user->id)}}">
                  ...
                  <div class="flex flex-col space-y-2 pb-3">
                    ...
                    <input id="designation" type="text" name="designation" value="{{ old('designation',$user->designation) }}"
                      placeholder="Enter designation" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                  </div>

                  <div class="flex flex-col space-y-2 pb-3">
                    <label for="office_name" class="text-gray-700 select-none font-medium">Office</label>
                  ...
                  <div class="flex flex-col space-y-2 pb-3">
                    <label for="number" class="text-gray-700 select-none font-medium">Phone Number</label>
                    <input id="number" type="number" name="number" value="{{ old('number',$user->number) }}"
                      placeholder="Enter number" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                    />
                  </div>
