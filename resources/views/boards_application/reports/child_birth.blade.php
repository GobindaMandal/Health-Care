          ...
          <table id="dataTable" class="table table-bordered text-left w-full border-collapse">
            <thead>
              <tr>
                ...
                <th class="align-middle text-center text-sm">সন্তান (কততম)</th>
            ...
            <tbody>
              @can('Boards application access')
                ...
                @if(!empty($patientForm->child_birth))
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">{{ $patientForm->child_birth }} <br> {{ $patientForm->hospital_name }}</td>
