          ...
          <table id="dataTable" class="table table-bordered text-left w-full border-collapse">
            <thead>
              <tr>
                ...
                <th class="align-middle text-center text-sm">দূর্ঘটনার বিবরণ ও স্থান</th>
            ...
            <tbody>
              @can('Boards application access')
                ...
                @if(!empty($patientForm->accident_name))
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">{{ $patientForm->accident_name }} <br> {{ $patientForm->accident_place }}</td>
                  <td class="align-middle text-center text-sm">দা: {{ $report->claim_amount }} <br> প: {{ $report->total_amount }}</td>
