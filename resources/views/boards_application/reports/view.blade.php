                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->applicant_date }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->employee_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->joining_date }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <a href="{{ asset('back/applicationform/'.$reports->nid) }}" data-lightbox="image">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <a href="{{ asset('back/applicationform/'.$reports->bubo) }}" data-lightbox="image">
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->applicant_reason }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->relation_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 

                    @if($reports->applicant_reason === 'কল্যাণ ও চিত্তবিনোদন')
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12" id="help_type_container" style="display: block;">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->application_type }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="orders" class="table table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span>{{ $reports->claim_amount }}</span>
                                            </td>
                                            <td></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span>{{ $reports->total_amount }}</span>
                                            </td>
                                            <td></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <span>{{ $reports->allowed_amount }}</span>
                                            </td>
                                            <td></td>
                                        </tr>

                                        <tr>
                                            <td colspan="3" class="text-right">অনুমোদিত অনুদানের পরিমান :</td>
                                            <td class="align-middle text-center">
                                                <span>{{ $reports->approved_amount }}</span>
                                            </td>
                                            <td></td>
                                        </tr>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <span>{{ $reports->employee_sign }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <span>{{ $reports->employee_date }}</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->doctor_designation }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row m-3">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->controller_officer_name }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->controller_officer_designation }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $reports->controller_officer_date }}</span>
                                </div>
                            </div>
                        </div>
