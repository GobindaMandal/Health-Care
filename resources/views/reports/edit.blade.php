<x-app-layout>
    <div class="container mx-auto px-6 py-2">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12">
            ...
            <div class="form-body">
                <form action="{{ route('update.reports', $reports->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="applicant_date" id="applicant_date" value="{{ $reports->applicant_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="fiscal_year" id="fiscal_year" placeholder="অর্থ বছর" value="{{ $reports->fiscal_year }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="office_name" id="office_name" placeholder="অফিসের নাম" value="{{ $reports->office_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="employee_name" id="employee_name" placeholder="কর্মকর্তা/ কর্মচারীর নাম" value="{{ $reports->employee_name }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="ERP_number" id="ERP_number" placeholder="ই আর পি নম্বর" value="{{ $reports->ERP_number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="designation" id="designation" placeholder="পদবী" value="{{ $reports->designation }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="joining_date" id="joining_date" value="{{ $reports->joining_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="grade" id="grade" placeholder="গ্রেড" value="{{ $reports->grade }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="number" class="form-control" name="number" id="number" placeholder="মোবাইল নং" value="{{ $reports->number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="email" class="form-control" name="email" id="email" placeholder="ইমেইল" value="{{ $reports->email }}">
                                </div>
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <img src="{{ asset('back/applicationform/'.$reports->nid) }}" alt="" width="50" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <img src="{{ asset('back/applicationform/'.$reports->bubo) }}" alt="" width="50" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <label for="text" class="fw-bold">আবেদনের কারণ :</label>
                                </div>
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="applicant_reason" id="applicant_reason">
                                       <option value="">{{ $reports->applicant_reason }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="relation_name" id="relation_name">
                                       <option value="">{{ $reports->relation_name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach($reports1 as $application)
                    ...
                    <div class="row m-3">
                        ...
                        <!-- daughters marriage -->
                        @foreach($reports4 as $application)
                                            ...
                                            <table id="" class="table table-bordered" style="width:100%">
                                                ...
                                                <tbody style="background-color: f4f4f4;">
                                                    <tr id="row">
                                                        ...
                                                        <td>
                                                            <textarea readonly style="border: 1px solid #787474;" class="form-control" type='text' id='employee_details' name='employee_details'
                                                            cols="40" rows="1">{{ $application->employee_details }}</textarea>
                                                        </td>
                                                        <td>
                                                            <input readonly style="border: 1px solid #787474;" class="form-control" type='text' id='help_type' name='help_type' value="{{ $application->help_type }}">
                                                        </td>
                                                        <td>
                                                            <input readonly style="border: 1px solid #787474;" class="form-control" type='number' id='amount' name='amount' value="{{ $application->amount }}">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                        ...
                        <!-- meritocracy -->
                        @foreach($reports5 as $application)
                        ...
                        <!-- deadbody -->
                        @foreach($reports6 as $application)
                            ...
                            <div class="card-body">
                                ...
                                <table id="orders" class="table table-bordered" style="width:100%">
                                    ...
                                    <tbody style="background-color: f4f4f4;">
                                        ...
                                        @foreach($reports2 as $application)
                                        <tr id="row">
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="employee_sign" id="employee_sign" placeholder="কর্মকর্তা/ কর্মচারীর সাক্ষর" value="{{ $reports->employee_sign }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row m-3">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="employee_date" id="employee_date" placeholder="তারিখ" value="{{ $reports->employee_date }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly readonly type="text" class="form-control" name="doctor_name" id="doctor_name"  value="{{ $reports->doctor_name }}" placeholder="অনুমোদিত চিকিৎসকের নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly readonly type="text" class="form-control" name="doctor_designation" id="doctor_designation"  value="{{ $reports->doctor_designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly readonly type="date" class="form-control" name="doctor_date" id="doctor_date" placeholder="তারিখ" value="{{ $reports->doctor_date }}" placeholder="তারিখ">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly readonly type="text" class="form-control" name="controller_officer_name" id="controller_officer_name"  value="{{ $reports->controller_officer_name }}" placeholder="নিয়ন্ত্রণকারী কর্মকর্তার নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly readonly type="text" class="form-control" name="controller_officer_designation" id="controller_officer_designation"  value="{{ $reports->controller_officer_designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly readonly type="date" class="form-control" name="controller_officer_date" id="controller_officer_date" placeholder="তারিখ" value="{{ $reports->controller_officer_date }}" >
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col text-center">
                        ...
                        <!-- <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#rejectModal{{$reports->id}}">Reject</button> -->
                    </div>
...
<!-- Reject Modal -->
<div class="modal fade" id="rejectModal{{$reports->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ Route('update.r_reports', $reports->id) }}" method="POST">
            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        ...
                                        <table id="dataTable" class="table table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                @foreach ($reports10 as $applicationList)
                                                <tr>
                                                    <td>1</td>
                                                    ...
                                                    <td>{{ $applicationList->applicant_date }}</td>
