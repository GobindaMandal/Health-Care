        ...
        <form action="{{ route('filter') }}" method="GET">
            <div class="row mb-3">
              ...
              <div class="col-md-3">
                ...
                <input class="form-control form-control-sm text-sm" type="date" name="search_date" id="search_date">
              </div>
              <div class="col-md-1">
          ...
          <table id="dataTable" class="table table-bordered text-left w-full border-collapse">
            <thead>
              <tr>
                ...
                <th class="align-middle text-center text-sm">প্রস্তাবিত অনুদানের পরিমান</th>
              ...
              @can('Report access')
                ...
                <tr class="hover:bg-grey-lighter">
                  ...
                  <td class="align-middle text-center text-sm text-center">
                    @can('Report edit')
                    <a href="{{route('edit.reports',$report->id)}}" class="ml-2"><i class="fa-sharp fa-regular fa-eye"></i></a>
                    @endcan
                  </td>
                </tr>
                <?php $sl++; ?>
