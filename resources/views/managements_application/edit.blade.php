<x-app-layout>
    <div class="container mx-auto px-6 py-2">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12">
            ...
            <div class="form-body">
                <form action="{{ route('update.managementsApplication', $managements_application->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="applicant_date" id="applicant_date" value="{{ $managements_application->applicant_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="fiscal_year" id="fiscal_year" placeholder="অর্থ বছর" value="{{ $managements_application->fiscal_year }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="office_name" id="office_name" placeholder="অফিসের নাম" value="{{ $managements_application->office_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="employee_name" id="employee_name" placeholder="কর্মকর্তা/ কর্মচারীর নাম" value="{{ $managements_application->employee_name }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="ERP_number" id="ERP_number" placeholder="ই আর পি নম্বর" value="{{ $managements_application->ERP_number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="designation" id="designation" placeholder="পদবী" value="{{ $managements_application->designation }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="joining_date" id="joining_date" value="{{ $managements_application->joining_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="grade" id="grade" placeholder="গ্রেড" value="{{ $managements_application->grade }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="number" class="form-control" name="number" id="number" placeholder="মোবাইল নং" value="{{ $managements_application->number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="email" class="form-control" name="email" id="email" placeholder="ইমেইল" value="{{ $managements_application->email }}">
                                </div>
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <a href="{{ asset('back/applicationform/'.$managements_application->nid) }}" data-lightbox="image">
                                        <img src="{{ asset('back/applicationform/'.$managements_application->nid) }}" alt="" width="50" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <a href="{{ asset('back/applicationform/'.$managements_application->bubo) }}" data-lightbox="image">
                                        <img src="{{ asset('back/applicationform/'.$managements_application->bubo) }}" alt="" width="50" />
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="applicant_reason" id="applicant_reason">
                                       <option value="">{{ $managements_application->applicant_reason }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="relation_name" id="relation_name">
                                       <option value="">{{ $managements_application->relation_name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    @if($managements_application->applicant_reason === 'কল্যাণ ও চিত্তবিনোদন')
                    <div class="row m-3">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="help_type" id="help_type">
                                       @if(App\Models\Back\Daughter_Marriage::where('application_id', $managements_application->id)->first())
                                       <option value=" {{ App\Models\Back\Daughter_Marriage::where('application_id', $managements_application->id)->first('help_type')}}"> {{App\Models\Back\Daughter_Marriage::where('application_id', $managements_application->id)->first()->help_type}}</option>

                                       @elseif( App\Models\Back\Meritocracy::where('application_id', $managements_application->id)->first())
                                       <option value=" {{ App\Models\Back\Meritocracy::where('application_id', $managements_application->id)->first('help_type')}}"> {{App\Models\Back\Meritocracy::where('application_id', $managements_application->id)->first()->help_type}}</option>

                                       @elseif( App\Models\Back\Deadbody::where('application_id', $managements_application->id)->first())
                                       <option value=" {{ App\Models\Back\Deadbody::where('application_id', $managements_application->id)->first('help_type')}}"> {{App\Models\Back\Deadbody::where('application_id', $managements_application->id)->first()->help_type}}</option>
                                       @endif
                                    </select>
                                </div>
                            </div>
                    ...
                    @foreach($managements_application1 as $application)
                    ...
                    <div class="row m-3">
                        ...
                        <!-- daughters marriage -->
                        @foreach($managements_application4 as $application)
                        ...
                        <!-- meritocracy -->
                        @foreach($managements_application5 as $application)
                        ...
                        <!-- deadbody -->
                        @foreach($managements_application6 as $application)
                    ...
                    @if(isset($managements_application3))
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <table id="orders" class="table table-bordered" style="width:100%">
                                    ...
                                    <tbody style="background-color: f4f4f4;">
                                        ...
                                        @foreach($managements_application2 as $application)
                                        <tr id="row">
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="employee_sign" id="employee_sign" placeholder="কর্মকর্তা/ কর্মচারীর সাক্ষর" value="{{ $managements_application->employee_sign }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="employee_date" id="employee_date" placeholder="তারিখ" value="{{ $managements_application->employee_date }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="doctor_name" id="doctor_name"  value="{{ $managements_application->doctor_name }}" placeholder="অনুমোদিত চিকিৎসকের নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="doctor_designation" id="doctor_designation"  value="{{ $managements_application->doctor_designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="doctor_date" id="doctor_date" placeholder="তারিখ" value="{{ $managements_application->doctor_date }}" placeholder="তারিখ">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="controller_officer_name" id="controller_officer_name"  value="{{ $managements_application->controller_officer_name }}" placeholder="নিয়ন্ত্রণকারী কর্মকর্তার নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="controller_officer_designation" id="controller_officer_designation"  value="{{ $managements_application->controller_officer_designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="controller_officer_date" id="controller_officer_date" placeholder="তারিখ" value="{{ $managements_application->controller_officer_date }}" >
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col text-center">
                        ...
                        <!-- <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#rejectModal{{$managements_application->id}}">Reject</button> -->
                    </div>
...
<!-- Reject Modal -->
<div class="modal fade" id="rejectModal{{$managements_application->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ Route('update.r_managementsApplication', $managements_application->id) }}" method="POST">
            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        ...
                                        <table id="dataTable" class="table table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php $sl=1; ?>
                                                @foreach ($managements_application10 as $applicationList)
                                                <tr>
                                                    <td>{{ $sl }}</td>
