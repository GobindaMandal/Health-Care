      ...
      <div class="container mx-auto px-6 py-2">
          <!-- <div class="text-right">
            @can('Application create')
              <a href="{{route('admin.applications.create')}}" class="underline bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New Application</a>
            @endcan
          </div> -->
              ...
              @can('Application access')
                ...
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                    ...
                    @elseif($application->status=='management_approved')
                    ...
                    @elseif($application->status=='committee_approved')
                    ...
                    @elseif($application->status=='controller_approved')
                    ...
                    @elseif($application->status=='doctor_approved')
                    ...
                    @elseif($application->status=='doctor_rejected')
                    ...
                    @elseif($application->status=='admin_approved')
                    ...
                    @elseif($application->status=='admin_rejected')
                  ...
                  <td class="align-middle text-center text-sm">
                    ...
                    <a href="{{route('edit.applications',$application->id)}}" class="underline text-white font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400" style="background-color: #56A5EC;">View</a>
                    @endcan
                  </td>
                </tr>
                <?php $sl++; ?>
