                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->applicant_date }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->fiscal_year }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->office_name }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->employee_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->ERP_number }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->designation }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->joining_date }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->grade }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->number }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->email }}</span>
                                </div>
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->applicant_reason }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->relation_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12" id="help_type_container" style="display: block;">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $doctors_application->application_type }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <span>{{ $doctors_application->employee_sign }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <span>{{ $doctors_application->employee_date }}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input type="text" class="form-control" name="doctor_name" id="doctor_name" value="{{ $doctors_application9->name }}" placeholder="অনুমোদিত চিকিৎসকের নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input type="text" class="form-control" name="doctor_designation" id="doctor_designation" value="{{ $doctors_application9->designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row ">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input type="date" class="form-control" name="doctor_date" id="doctor_date" placeholder="তারিখ" value="{{ date('Y-m-d') }}" placeholder="তারিখ">
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ Route('update.r_doctorsApplication', $doctors_application->id) }}" method="POST">
            ...
            <input type="hidden" name="doctor_name" id="doctor_name" value="{{ $doctors_application9->name }}">
            <input type="hidden" name="doctor_designation" id="doctor_designation" value="{{ $doctors_application9->designation }}">
            <input type="hidden" name="doctor_date" id="doctor_date" value="{{ date('Y-m-d') }}">
