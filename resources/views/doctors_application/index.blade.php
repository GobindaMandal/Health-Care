  ...
  <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
      <div class="container mx-auto px-6 py-2">
          <div class="text-right">
            @can('Doctors application create')
              <a href="{{route('admin.doctorsApplication.create')}}" class="underline bg-blue-500 text-white font-bold px-5 py-1 rounded focus:outline-none shadow hover:bg-blue-500 transition-colors ">New doctors application</a>
            @endcan
          </div>
          ...
          <table id="dataTable" class="table table-bordered text-left w-full border-collapse">
            ...
            <tbody>
              @can('Doctors application access')
                <?php $sl=1; ?>
                @foreach($doctors_application as $application)
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                    ...
                    <a href="{{route('edit.doctorsApplication',$application->id)}}" class="underline text-white font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400" style="background-color: #56A5EC;">View</a>
                    @endcan
                  </td>
                </tr>
                <?php $sl++; ?>
