  ...
  <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
      <div class="container mx-auto px-6 py-2">
        ...
        <div class="p-3 bg-white shadow-md rounded my-6">
          <form action="{{ route('filter.controllersApplication') }}" method="GET">
            <div class="row mb-3">
              <div class="col-md-2">
              ...
              @can('Controllers application access')
                ...
                <tr>
                  ...
                  <td class="align-middle text-center text-sm">
                      @if($report->status=='doctor_approved')
                  ...
                  <td class="align-middle text-center text-sm">
                    ...
                    <a href="{{route('viewReport.controllersApplication',$report->id)}}" class="ml-2"><i class="fa-sharp fa-regular fa-eye"></i></a>
                    @endcan
                  </td>
                </tr>
                <?php $sl++; ?>
