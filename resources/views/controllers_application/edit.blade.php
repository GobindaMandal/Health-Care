<x-app-layout>
    <div class="container mx-auto px-6 py-2">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12 col-sm-12">
            ...
            <div class="form-body">
                <form action="{{ route('update.controllersApplication', $controllers_application->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="applicant_date" id="applicant_date" value="{{ $controllers_application->applicant_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="fiscal_year" id="fiscal_year" placeholder="অর্থ বছর" value="{{ $controllers_application->fiscal_year }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="office_name" id="office_name" placeholder="অফিসের নাম" value="{{ $controllers_application->office_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="employee_name" id="employee_name" placeholder="কর্মকর্তা/ কর্মচারীর নাম" value="{{ $controllers_application->employee_name }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="ERP_number" id="ERP_number" placeholder="ই আর পি নম্বর" value="{{ $controllers_application->ERP_number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="designation" id="designation" placeholder="পদবী" value="{{ $controllers_application->designation }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="date" class="form-control" name="joining_date" id="joining_date" value="{{ $controllers_application->joining_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="text" class="form-control" name="grade" id="grade" placeholder="গ্রেড" value="{{ $controllers_application->grade }}">
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="number" class="form-control" name="number" id="number" placeholder="মোবাইল নং" value="{{ $controllers_application->number }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <input readonly type="email" class="form-control" name="email" id="email" placeholder="ইমেইল" value="{{ $controllers_application->email }}">
                                </div>
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <a href="{{ asset('back/applicationform/'.$controllers_application->nid) }}" data-lightbox="image">
                                        <img src="{{ asset('back/applicationform/'.$controllers_application->nid) }}" alt="" width="50" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <a href="{{ asset('back/applicationform/'.$controllers_application->bubo) }}" data-lightbox="image">
                                        <img src="{{ asset('back/applicationform/'.$controllers_application->bubo) }}" alt="" width="50" />
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="applicant_reason" id="applicant_reason">
                                       <option value="">{{ $controllers_application->applicant_reason }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="relation_name" id="relation_name">
                                       <option value="">{{ $controllers_application->relation_name }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    @if($controllers_application->applicant_reason === 'কল্যাণ ও চিত্তবিনোদন')
                    <div class="row m-3">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <select readonly class="form-select" name="help_type" id="help_type">
                                       @if(App\Models\Back\Daughter_Marriage::where('application_id', $controllers_application->id)->first())
                                       <option value=" {{ App\Models\Back\Daughter_Marriage::where('application_id', $controllers_application->id)->first('help_type')}}"> {{App\Models\Back\Daughter_Marriage::where('application_id', $controllers_application->id)->first()->help_type}}</option>

                                       @elseif( App\Models\Back\Meritocracy::where('application_id', $controllers_application->id)->first())
                                       <option value=" {{ App\Models\Back\Meritocracy::where('application_id', $controllers_application->id)->first('help_type')}}"> {{App\Models\Back\Meritocracy::where('application_id', $controllers_application->id)->first()->help_type}}</option>

                                       @elseif( App\Models\Back\Deadbody::where('application_id', $controllers_application->id)->first())
                                       <option value=" {{ App\Models\Back\Deadbody::where('application_id', $controllers_application->id)->first('help_type')}}"> {{App\Models\Back\Deadbody::where('application_id', $controllers_application->id)->first()->help_type}}</option>
                                       @endif
                                    </select>
                                </div>
                            </div>
                    ...
                    @foreach($controllers_application1 as $application)
                    ...
                    <div class="row m-3">
                        ...
                        <!-- daughters marriage -->
                        @foreach($controllers_application4 as $application)
                        ...
                        <!-- meritocracy -->
                        @foreach($controllers_application5 as $application)
                        ...
                        <!-- deadbody -->
                        @foreach($controllers_application6 as $application)
                    ...
                    @if(isset($controllers_application3))
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-body">
                                ...
                                <table id="orders" class="table table-bordered" style="width:100%">
                                    ...
                                    <tbody style="background-color: f4f4f4;">
                                        ...
                                        @foreach($controllers_application2 as $application)
                                        <tr id="row">
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="employee_sign" id="employee_sign" placeholder="কর্মকর্তা/ কর্মচারীর সাক্ষর" value="{{ $controllers_application->employee_sign }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="employee_date" id="employee_date" placeholder="তারিখ" value="{{ $controllers_application->employee_date }}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="controller_officer_name" id="controller_officer_name"  value="{{ $controllers_application9->name }}" placeholder="নিয়ন্ত্রণকারী কর্মকর্তার নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="text" class="form-control" name="controller_officer_designation" id="controller_officer_designation"  value="{{ $controllers_application9->designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input readonly type="date" class="form-control" name="controller_officer_date" id="controller_officer_date" placeholder="তারিখ" value="{{ date('Y-m-d') }}" >
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col text-center">
                        ...
                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#rejectModal{{$controllers_application->id}}">Reject</button>
                    </div>
...
<!-- Reject Modal -->
<div class="modal fade" id="rejectModal{{$controllers_application->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ Route('update.r_controllersApplication', $controllers_application->id) }}" method="POST">
            @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="card-body">
                                        ...
                                        <table id="dataTable" class="table table-bordered" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php $sl=1; ?>
                                                @foreach ($controllers_application10 as $applicationList)
                                                <tr>
                                                    <td>{{ $sl }}</td>
