                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->applicant_date }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->fiscal_year }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->office_name }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->employee_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->ERP_number }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->designation }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->joining_date }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->grade }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->number }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->email }}</span>
                                </div>
                            </div>
                        </div>
                    </div>  
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->applicant_reason }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->relation_name }}</span>
                                </div>
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="row m-3">
                        <div class="col-lg-6 col-md-6 col-sm-12" id="help_type_container" style="display: block;">
                            <div class="row ">
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12">
                                    <span>{{ $controllers_application->application_type }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <span>{{ $controllers_application->employee_sign }}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <span>{{ $controllers_application->employee_date }}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row m-3">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input type="text" class="form-control" name="controller_officer_name" id="controller_officer_name"  value="{{ $controllers_application9->name }}" placeholder="নিয়ন্ত্রণকারী কর্মকর্তার নাম">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input type="text" class="form-control" name="controller_officer_designation" id="controller_officer_designation"  value="{{ $controllers_application9->designation }}" placeholder="পদবী">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-12">
                                        <input type="date" class="form-control" name="controller_officer_date" id="controller_officer_date" placeholder="তারিখ" value="{{ date('Y-m-d') }}" >
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ Route('update.r_controllersApplication', $controllers_application->id) }}" method="POST">
            ...
            <input type="hidden" name="controller_officer_name" id="controller_officer_name" value="{{ $controllers_application9->name }}">
            <input type="hidden" name="controller_officer_designation" id="controller_officer_designation" value="{{ $controllers_application9->designation }}">
            <input type="hidden" name="controller_officer_date" id="controller_officer_date" value="{{ date('Y-m-d') }}">
